...
export def AddMenuExtra()
  ...
  anoremenu 1000.1000.1019.26 &Extra.&Plugins.&Searcher.&PopupMarks<Tab>Leader>f' <Plug>(searcher-popup-marks)
  anoremenu 1000.1000.1019.27 &Extra.&Plugins.&Searcher.&PopupHistoryEx<Tab>Leader>f: <Plug>(searcher-popup-history-ex)
  anoremenu 1000.1000.1019.28 &Extra.&Plugins.&Searcher.&PopupHistorySearch<Tab>Leader>f/ <Plug>(searcher-popup-history-search)
